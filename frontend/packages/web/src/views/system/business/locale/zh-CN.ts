export default {
  ...
  'system.business.modelSettings.globalDailyLimitColumn': '日调用量上限(次)',
  'system.business.modelSettings.todayUsage': '今日调用量(次)',
  ...
  'system.business.modelSettings.timesTip': '（次数）',
  ...
  'system.business.globalTask.triggerCondition': '触发条件',
